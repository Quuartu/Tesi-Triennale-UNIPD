...
\usepackage{fvextra}                            % per avere più controllo su un warning
...
\begin{document}
    ...
    \input{Capitoli/FdTeoriciSuAutomRoboticaInd}
    \input{Capitoli/ProgettazioneSistemaSCADA}
    \input{Capitoli/CasoStudio}
